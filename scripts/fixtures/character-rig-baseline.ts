// Frozen historical sampler from main@7889a0066df928b101d42fb16f32353bd26c0696.
// Source: web/lib/character-rig.ts. Benchmark/reference only; never imported by the app.
export type CharacterMotion = "idle" | "walk" | "wave";
export type CharacterPose = {
  rootX: number; rootY: number; rootYaw: number; spineZ: number;
  leftShoulderX: number; rightShoulderX: number; rightShoulderZ: number;
  leftElbowX: number; rightElbowX: number; leftHipX: number; rightHipX: number;
